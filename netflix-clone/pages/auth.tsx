            ...
            <div className='bg-black w-full h-full lg:bg-opacity-50' >
                ...
                <div className='flex justify-center'>
                    <div className='bg-black bg-opacity-50 px-16 py-16 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full'>
                        ...
                        <button onClick={variant === 'login'? login: register} className="bg-red-500 text-white py-3 rounded-md w-full mt-10 hover:bg-red-600 transition">
                        ...
                        <p className="text-neutral-500 mt-12">
                            ...
                            <span onClick={toggleVariant} className="text-white ml-1 hover:underline cursor-pointer cursor-pointer">
